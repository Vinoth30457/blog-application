...
function CreateBlog() {
  ...
  const { mode, updateBlog, editBlog, setEditBlog, loading, setloading } =
    context;
      ...
      >
        ...
        <div className="mb-3">
          ...
          {editBlog.thumbnail && (
            <img
              ...
              src={photo ? URL.createObjectURL(photo) : editBlog.thumbnail}
              alt="thumbnail"
            />
          )}
          {/* {thumbnail && (
            ...
            onChange={(e) => {
              ...
              uploadBytes(imageRef, e.target.files[0]).then((snapshot) => {
                getDownloadURL(snapshot.ref).then((url) => {
                  console.log(url);
                  setloading(false);
                  setEditBlog({ ...editBlog, thumbnail: url });
                });
              });
            }}
          />
        ...
        <Editor
          ...
          onEditorChange={(newValue, editor) => {
            setEditBlog({ ...editBlog, content: newValue });
          ...
          <div className="content">
            <div
              className={`[&> h1]:text-[32px] [&>h1]:font-bold  [&>h1]:mb-2.5
                        ...
                        [&>img]:rounded-lg
                        `}
              dangerouslySetInnerHTML={createMarkup(editBlog.content)}
            ></div>
          </div>
        </div>
      </div>
